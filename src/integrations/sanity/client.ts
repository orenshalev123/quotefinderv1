...
export const SANITY_PROJECT_ID = import.meta.env.VITE_SANITY_PROJECT_ID || 'your-project-id';
export const SANITY_DATASET = import.meta.env.VITE_SANITY_DATASET || 'production';
export const SANITY_API_VERSION = import.meta.env.VITE_SANITY_API_VERSION || '2023-08-01';
